...
export default function Home() {
    ...
    return (
        <div>
            <h1 className="border-bottom my-2">syun560 page</h1>
            <div className="shadow row">
                <div className="col">
                    <h2>Profile</h2>
                    <ul>
                        <li>python/Django, VR, music and programming</li>
                        <li>TOEIC Score: 770 </li>
                        <li>Applied Information Technology Engineer(応用情報技術者) </li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>edit movie by AviUtl</li>
                        <li>manage my own heartbeat using by <a href="">fitbit API</a></li>
                        <li>domain</li>
                    </ul>
